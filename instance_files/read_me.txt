...
The instances were created using Python and stored using the module pickle so you will need both to read them.
...
This will create two Python object that you can now use:
 - graph : this object is a list containing one dictionnary per node, the keys of the dictionnary present at index i are indices of the neighbors of the node i. The value corresponding to the neighbor j is a number describing the capacity of the arc (i, j)
